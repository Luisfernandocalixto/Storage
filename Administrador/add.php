   ...
   <form method="post" action="action_add.php">
      <table border="0" width="500">
         <tr>
            ...
            <td>:</td>
            <td><input type="url" name="enlace" placeholder="Ingrese url de imagen" required></td>
         </tr>
         <tr>
            <td><label for="">Imagen 1</label></td>
            <td>:</td>
            <td><input type="url" name="imagen" placeholder="Ingrese url de evento" required></td>
         </tr>
         <tr>
            <td><label for="">Imagen 2</label></td>
            <td>:</td>
            <td><input type="url" name="imagen2" placeholder="Ingrese url de imagen" required></td>
         </tr>
         <tr>
            <td><label for="">Enlace 2</label></td>
            <td>:</td>
            <td><input type="url" name="enlace2" placeholder="Ingrese url de evento" required></td>
         </tr>
         <tr>
            <td><label for="">Imagen 3</label></td>
            <td>:</td>
            <td><input type="url" name="imagen3" placeholder="Ingrese url de imagen" required></td>
         </tr>
         <tr>
            <td><label for="">Enlace 3</label></td>
            <td>:</td>
            <td><input type="url" name="enlace3" placeholder="Ingrese url de evento" required></td>
         </tr>
         <tr>
            <td><label for="">Imagen 4</label></td>
            <td>:</td>
            <td><input type="url" name="imagen4" placeholder="Ingrese url de imagen" required></td>
         </tr>
         <tr>
            <td><label for="">Enlace 4</label></td>
            <td>:</td>
            <td><input type="url" name="enlace4" placeholder="Ingrese url de evento" required></td>
         </tr>
         <tr>
